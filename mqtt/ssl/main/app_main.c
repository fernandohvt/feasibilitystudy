...
static esp_err_t mqtt_event_handler_cb(esp_mqtt_event_handle_t event)
{
    ...
    switch (event->event_id) {
        case MQTT_EVENT_CONNECTED:
            // Assinando tópico que será medido RTT 
                msg_id = esp_mqtt_client_subscribe(client, "/topic/fh/qos1", 1);
            /////////////////////////////////////////////////////////////////
            break;
        case MQTT_EVENT_DATA:
            
            //Calculando o tempo de resposta do dado que foi enviado por publish
                tempo_req = (esp_timer_get_time() - tempo_inicial)/1000;
                printf("%ld\r\n",tempo_req);
           //////////////////////////////////////////////////////////////////////
...
static void mqtt_app_start(void)
{
    ...
    while  (cont < 100 ){
                ...
                char * msg = "Teste RTT MQTT QoS 0";
                msg_id = esp_mqtt_client_publish(client, "/topic/fh/qos1", msg , 0, 1, 0);
                cont++;  
    }
    //--------------FIM DO EXPERIMENTO--------------------------------------------------------------
}
